            ...
            <AnimatePresence>
              {profileOpen && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-2 w-64 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-secondary)] shadow-xl shadow-black/30 backdrop-blur-xl overflow-hidden z-[200]"
                >
                  ...
                  <div className="p-2">
                    {profileMenu.map((item) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-colors text-left"
                      >
                        <span className="text-[var(--text-tertiary)]">{item.icon}</span>
                        <div>
                          <Text className="text-sm font-medium">{item.label}</Text>
                          <Muted className="text-xs">{item.desc}</Muted>
                        </div>
                      </button>
                    ))}
                  </div>
